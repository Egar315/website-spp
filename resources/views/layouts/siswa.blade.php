...
<head>
    ...
    <title>@yield('title', 'Dashboard Siswa') - Sistem SPP</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            background: linear-gradient(175deg, #1e3a8a 0%, #1a2035 100%);
        ...
        .brand-logo {
            width: 40px; height: 40px; background: linear-gradient(135deg, #38bdf8, #0284c7);
            border-radius: 50%; display: flex; align-items: center; justify-content: center;
            font-weight: 700; font-size: 1.1rem; color: white; box-shadow: 0 4px 10px rgba(56,189,248,0.4);
        }
        .brand-text h4 { margin: 0; font-size: 1rem; font-weight: 700; }
        .brand-text p  { margin: 0; font-size: 0.75rem; color: #38bdf8; }

        .sidebar-menu { list-style: none; padding: 0; margin: 0; flex-grow: 1; }
        .sidebar-menu li { padding: 4px 14px; }
        .sidebar-menu a {
            display: flex; align-items: center; padding: 11px 14px;
            color: #94a3b8; text-decoration: none; border-radius: 12px;
            font-weight: 500; font-size: 0.9rem; gap: 10px; transition: all 0.2s;
        }
        .sidebar-menu a:hover { color: #fff; background: rgba(255,255,255,0.07); }
        .sidebar-menu a i { font-size: 1.1rem; }
        .sidebar-menu a.active {
            background: linear-gradient(to right, #38bdf8, #0ea5e9);
            color: white; box-shadow: 0 4px 15px rgba(56,189,248,0.3);
        }
        .sidebar-footer { padding: 20px; }
        .version-box { background: rgba(255,255,255,0.06); padding: 10px 12px; border-radius: 10px; font-size: 0.75rem; color: #94a3b8; }
        ...
        .welcome-text p  { margin: 0; font-size: 0.83rem; color: #64748b; }
        .welcome-text h5 { margin: 0; font-size: 1.05rem; font-weight: 700; color: #1e293b; }
        .topbar-right { display: flex; align-items: center; gap: 18px; }
        .notif-btn { background: none; border: none; position: relative; color: #64748b; font-size: 1.2rem; padding: 0; }
        .notif-badge {
            position: absolute;
            top: -6px;
            right: -8px;
        ...
        .role-badge {
            ...
            display: flex; align-items: center; gap: 6px; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.2);
        }
        .logout-btn {
        ...
        .content-area { padding: 32px 40px; flex-grow: 1; }
...
<div class="sidebar">
    ...
    <ul class="sidebar-menu mt-2">
        <li>
            <a href="{{ route('siswa.dashboard') }}" class="{{ request()->is('siswa') ? 'active' : '' }}">
                <i class="bi bi-house-door"></i> Dashboard
            </a>
        </li>
        <li>
            <a href="{{ route('siswa.pay') }}" class="{{ request()->is('siswa/pay') ? 'active' : '' }}">
                <i class="bi bi-credit-card"></i> Bayar SPP
            </a>
        </li>
        <li>
            <a href="{{ route('siswa.history') }}" class="{{ request()->is('siswa/history') ? 'active' : '' }}">
        ...
        <div class="topbar-right">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0" style="width: 320px; border-radius: 16px; padding: 0; overflow: hidden; margin-top: 15px;" id="notifDropdownMenu">
                        ...
                        <li><a href="{{ route('siswa.history') }}" class="dropdown-item text-center py-2 bg-light border-top text-primary fw-bold" style="font-size: 0.8rem;">Lihat Semua Riwayat</a></li>
                    </ul>
                </div>
