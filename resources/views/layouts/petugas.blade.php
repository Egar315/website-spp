...
<head>
    ...
    <title>@yield('title', 'Portal Petugas') - Sistem SPP</title>
    ...
    <style>
        ...
        .brand-text p  { margin: 0; font-size: 0.75rem; color: #009cff; }
        ...
        .sidebar-menu a:hover { color: #fff; background: rgba(255,255,255,0.05); }
        .sidebar-menu a i { font-size: 1.15rem; }
        ...
        .version-box { background-color: #242a42; padding: 10px 12px; border-radius: 10px; font-size: 0.75rem; color: #a0aec0; }
        ...
        .role-badge {
            ...
            padding: 5px 14px; border-radius: 20px; font-size: 0.83rem; font-weight: 600;
            display: flex; align-items: center; gap: 5px;
        }
        .logout-btn {
            color: #ef4444; background: none; border: none; font-weight: 500; font-size: 0.88rem;
...
<div class="sidebar">
    ...
    <ul class="sidebar-menu mt-2">
        <li>
            <a href="{{ route('petugas.verification') }}" class="{{ request()->is('petugas/verification') ? 'active' : '' }}">
                <i class="bi bi-patch-check"></i> Verifikasi Pembayaran
            </a>
        </li>
        <li>
            <a href="{{ route('petugas.direct') }}" class="{{ request()->is('petugas/direct') ? 'active' : '' }}">
                <i class="bi bi-cash-coin"></i> Pembayaran Langsung
            </a>
        </li>
    </ul>
        ...
        <div class="topbar-right">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0" style="width: 320px; border-radius: 16px; padding: 0; overflow: hidden; margin-top: 15px;" id="notifDropdownMenu">
                        ...
                        <li><a href="{{ route('petugas.verification') }}" class="dropdown-item text-center py-2 bg-light border-top text-primary fw-bold" style="font-size: 0.8rem;">Lihat Semua Pembayaran</a></li>
                    </ul>
                </div>
